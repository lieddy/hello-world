...
function! UpdateTags(basedir)
    execute ":silent !cd ".a:basedir." && ctags -R --sort=yes --languages=c++ --langmap=c++:+.inl -h +.inl --c++-kinds=+px --fields=+aiKSz --extra=+q+f --exclude=build -f ~/.vim/tags/last_project_tags `pwd`"
    execute ":redraw!"
endfunction
